...
class GarageDoorAccessory extends BaseAccessory {
    ...
    _registerCharacteristics(dps) {
        ...
        this.targetOpen = Characteristic.TargetDoorState.FOPEN;
        this.targetClosed = Characteristic.TargetDoorState.FCLOSE;
        if (!!this.device.context.flipState) {
            ...
            this.targetOpen = Characteristic.TargetDoorState.FCLOSE;
            this.targetClosed = Characteristic.TargetDoorState.FOPEN;
        }
